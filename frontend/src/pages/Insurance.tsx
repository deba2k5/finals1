...
const Insurance = () => {
  ...
  const insuranceSchemes = [
    ...
    },
    {
      ...
      applyLink: 'https://www.india.gov.in/weather-based-crop-insurance-scheme-wbcis'
    },
    {
      name: 'MNAIS',
      ...
      applyLink: 'https://agritech.tnau.ac.in/crop_insurance/crop_insurance_mnais.html'
    }
  ];
            ...
            {insuranceSchemes.map((scheme) => (
              <div key={scheme.name} className="p-4 rounded-lg border border-border hover:border-primary/50 transition-colors">
                ...
                <div className="flex space-x-2 mt-3">
                  ...
                  <a href={scheme.applyLink} target="_blank" rel="noopener noreferrer" className="flex-1">
